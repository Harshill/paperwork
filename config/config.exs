...
config :paperwork, PaperworkWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PaperworkWeb.ErrorHTML, json: PaperworkWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Paperwork.PubSub,
  live_view: [signing_salt: "wtnf0Tr7"]
...
config :paperwork, Paperwork.Mailer, adapter: Swoosh.Adapters.Local
